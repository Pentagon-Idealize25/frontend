...
const ChatPage: React.FC = () => {
  ...
  const [sessionData, setSessionData] = useState<Session | null>(null); // Store session metadata
  ...
  const fetchMessages = useCallback(async (force = false) => {
    ...
    try {
      ...
      setSessionData(response.data.session || null); // Assuming session data is returned
      setState(prev => {
        const newMessages = response.data.messages || []; // Handle null/undefined response
